...
export default function Radar() {
    ...
    useEffect(() => {
        const title = currentLevel === 'province'? `ProvinceDataDaily.json`: 'CityDataDaily.json';
    ...
    function disabledDate(current) {
        return current < moment(new Date('2020/01/24')) || current > moment(new Date('2020/05/24'));
    }
    ...
    return (
        <div className={style['map']}>
            <div className="switch-btn">
                <span onClick={()=>selectBtn('confirmed')}><BorderBox7 className={currentBtn === 'confirmed'?'activeBtn btn': 'btn'}>新增确诊</BorderBox7></span>
                <span onClick={()=>selectBtn('suspected')}><BorderBox7 className={currentBtn === 'suspected'?'activeBtn btn': 'btn'}>新增疑似</BorderBox7></span>
                <span onClick={()=>selectBtn('cured')}><BorderBox7 className={currentBtn === 'cured'?'activeBtn btn': 'btn'}>新增治愈</BorderBox7></span>
                <span onClick={()=>selectBtn('dead')}><BorderBox7 className={currentBtn === 'dead'?'activeBtn btn': 'btn'}>新增死亡</BorderBox7></span>
                <span onClick={()=>changeLevel('china')}><BorderBox7 className="btn">全国</BorderBox7></span>
            </div>
            ...
            <div className="chart-container" style={{height: '45vh'}}
                 ref={container}
            />
        </div>
